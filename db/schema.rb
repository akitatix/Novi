...
ActiveRecord::Schema.define(version: 2020_02_25_160017) do
  ...
  create_table "skill_orders", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["skill_id"], name: "index_skill_orders_on_skill_id"
    t.index ["user_id"], name: "index_skill_orders_on_user_id"
  end
